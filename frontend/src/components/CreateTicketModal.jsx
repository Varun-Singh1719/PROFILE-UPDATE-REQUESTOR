 ...
 *
 * Mirrors the CreateTicketPage form 1:1 (description, priority, due date,
 * profile count, multi-file attachments + tips side panel) but renders as a
 * shadcn Dialog on top of the current screen instead of a routed page.
 *
 * Props:
        ...
        <div className="px-6 pt-5 pb-3 border-b border-gray-100 flex items-start justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1 max-w-2xl">
              Give the data-quality team the essentials — a short description,
              how urgent it is, and how many profiles are affected. Attach any
              reference files that will help.
            </p>
          </div>
          <button
            type="button"
            ...
            <aside className="space-y-4">
              <div className="bg-white rounded-xl border border-gray-100 p-5">
                <div className="flex items-center gap-2 text-gray-900 font-semibold mb-3">
                  <Lightbulb size={16} className="text-[#ec9324]" /> Tips for a
                  faster turnaround
                </div>
                <ul className="space-y-3 text-sm text-gray-600">
                  <li className="flex items-start gap-2">
                    <FileCheck2
                      size={14}
                      className="text-[#ec9324] mt-0.5 shrink-0"
                    />
                    <span>
                      Be specific in the description — what to fix and the
                      acceptance criteria.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    />
                    <span>
                      Set an accurate profile count so DQ can plan capacity
                      correctly.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      priority only when the request is blocking downstream
                      work.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    />
                    <span>
                      Attach sample files, screenshots or CSVs when they
                      clarify the ask.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-[#ec9324]/5 border border-[#ec9324]/20 rounded-xl p-4 text-sm text-gray-700">
                ...
                <p className="text-gray-600">
                  Once submitted, your request goes to the Data Quality queue.
                  You&apos;ll see it in the list and get updates as the DQ team
                  picks it up, works on it and closes it.
                </p>
              </div>
            </aside>
          </div>
