        ...
        "pages": [
            {
                ...
                "functions": [
                    ...
                    {"key": "search",          "label": "Search",         "scoped": False},
                    {"key": "filter_status",   "label": "Filter — Status","scoped": False},
                    {"key": "filter_priority", "label": "Filter — Priority","scoped": False},
                    {"key": "filter_assignee", "label": "Filter — Assignee","scoped": False},
                    {"key": "filter_date",     "label": "Filter — Date Range","scoped": False},
        ...
        "pages": [
            {
                ...
                "functions": [
                    ...
                    {"key": "search",          "label": "Search",             "scoped": False},
                    {"key": "filter_role",     "label": "Filter — Role",      "scoped": False},
                    {"key": "filter_status",   "label": "Filter — Status",    "scoped": False},
                    {"key": "filter_team",     "label": "Filter — Team",      "scoped": False},
                ],
            },
            {
            ...
            },
            {
                ...
                "functions": [
                    ...
                    {"key": "search",        "label": "Search",              "scoped": False},
                    {"key": "filter_module", "label": "Filter — Module",     "scoped": False},
                ],
            },
            {
                ...
                "functions": [
                    ...
                    {"key": "search",            "label": "Search",             "scoped": False},
                    {"key": "filter_channel",    "label": "Filter — Channel",   "scoped": False},
                    {"key": "filter_status",     "label": "Filter — Status",    "scoped": False},
                    {"key": "filter_date",       "label": "Filter — Date Range","scoped": False},
                ],
            },
        ...
        "pages": [
            {
                ...
                "functions": [
                    ...
                    {"key": "refresh",         "label": "Refresh",        "scoped": False},
                    {"key": "search",          "label": "Search",         "scoped": False},
                    {"key": "filter_date",     "label": "Filter — Date",  "scoped": False},
                    {"key": "filter_floor",    "label": "Filter — Floor", "scoped": False},
                    {"key": "filter_zone",     "label": "Filter — Zone",  "scoped": False},
                    {"key": "filter_employee", "label": "Filter — Employee","scoped": False},
                ],
            },
            {
                ...
                "functions": [
                    ...
                    {"key": "search",          "label": "Search",         "scoped": False},
                    {"key": "filter_date",     "label": "Filter — Date",  "scoped": False},
                    {"key": "filter_room",     "label": "Filter — Room",  "scoped": False},
                ],
            },
            {
            ...
            },
            {
                ...
                "functions": [
                    ...
                    {"key": "refresh",                "label": "Refresh",                 "scoped": False},
                    {"key": "search",                 "label": "Search",                  "scoped": False},
                    {"key": "filter_type",            "label": "Filter — Type",           "scoped": False},
                    {"key": "filter_date",            "label": "Filter — Date",           "scoped": False},
                ],
            },
            {
